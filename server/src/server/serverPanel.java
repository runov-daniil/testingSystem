...
public class serverPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getRequests = new javax.swing.JTable();
        ...
        getRequests.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(getRequests);

        jLabel1.setText("Принятые запросы:");
        ...
        onlineTable.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jScrollPane2.setViewportView(onlineTable);

        jLabel2.setText("Пользователи онлайн:");
        ...
        saveLogBTN.setText("Сохранить лог в файл");

        clearLogBTN.setText("Очистить лог");

        jLabel3.setText("Лог сервера:");
    ...
    public static javax.swing.JTable getRequests;
